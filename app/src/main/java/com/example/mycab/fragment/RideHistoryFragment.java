...
public class RideHistoryFragment extends Fragment{
    ...
    private RecyclerView rideHistoryFragmentRecyclerView;
    ...
    DatabaseReference databaseReference, ridingHistoryDatabaseReference, usersDatabaseReference;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        rideHistoryFragmentRecyclerView = view.findViewById(R.id.rideHistoryFragmentRecyclerView);
        rideHistoryFragmentRecyclerView.setLayoutManager(new LinearLayoutManager(getContext()));
    ...
    public void onStart() {
        ...
        FirebaseRecyclerOptions<RideHistoryModelClass> firebaseRecyclerOptions = new FirebaseRecyclerOptions.Builder<RideHistoryModelClass>().setQuery(ridingHistoryDatabaseReference.child(currentUserId),RideHistoryModelClass.class).build();
        ...
        FirebaseRecyclerAdapter<RideHistoryModelClass, RideHistoryViewHolder> firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<RideHistoryModelClass, RideHistoryViewHolder>(firebaseRecyclerOptions) {
            ...
            protected void onBindViewHolder(@NonNull RideHistoryViewHolder holder, int position, @NonNull RideHistoryModelClass model) {
                ...
                usersDatabaseReference.child(driverId).addValueEventListener(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        if(snapshot.exists()){
                            if(snapshot.hasChild(NodeNames.PROFILENAME)){
                                String name = snapshot.child(NodeNames.PROFILENAME).getValue().toString();
                ...
                StorageReference profileImage = storageReference.child(Constants.IMAGESFOLDER).child(driverId);
        ...
        rideHistoryFragmentRecyclerView.setAdapter(firebaseRecyclerAdapter);
